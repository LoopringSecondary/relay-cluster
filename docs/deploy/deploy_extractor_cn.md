...
申请EC2实例，配置时添加对CodeDeploy的支持，参考启动aws[EC2实例](new_ec2_cn.md)，并且关联`extractor-SecurityGroup`安全组

> 如果还没创建，请参考[aws安全组](security_group_cn.md)关于`extractor-SecurityGroup`部分的说明，创建后再关联
