...
## 配置安全组
为每个实例配置名为`extractor-SecurityGroup`的安全组，如果还没有创建，请参考[配置aws安全组](https://github.com/Loopring/relay-cluster/wiki/%E9%85%8D%E7%BD%AEaws%E5%AE%89%E5%85%A8%E7%BB%84)关于`extractor-SecurityGroup`部分的说明进行配置后再进行关联
