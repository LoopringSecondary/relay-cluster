...
For [IAM-User] select [Add User], for reference: [aws doc](https://docs.aws.amazon.com/zh_cn/codedeploy/latest/userguide/getting-started-provision-user.html)
...
### Creating a Role
For [IAM-Role] select [Create Role] for reference: [aws doc](https://docs.aws.amazon.com/zh_cn/codedeploy/latest/userguide/getting-started-create-service-role.html)
...
[IAM-Strategy], select [Create Strategy], Reference: [aws doc](https://docs.aws.amazon.com/zh_cn/codedeploy/latest/userguide/getting-started-provision-user.html)
...
> It recommended to configure the EC2 instance when starting it. Reference: [Support CodeDeploy](https://github.com/Loopring/relay-cluster/wiki/%E5%90%AF%E5%8A%A8aws-EC2%E5%AE%9E%E4%BE%8B#%E6%94%AF%E6%8C%81codedeploy), and if you have a similar configuration, you do not need to perform the following two operations.
### Configuration role
...
Click this link: [CodeDeploy](https://ap-northeast-1.console.aws.amazon.com/codedeploy), open the CodeDeploy console, and select [Start Now]
...
This is the phase identifier of the deployment. The specific definition can be referenced: [aws doc](https://docs.aws.amazon.com/zh_cn/codedeploy/latest/userguide/reference-appspec-file-structure-hooks.html)
* Failure log
...
Reference documents: [aws doc](https://docs.aws.amazon.com/zh_cn/codedeploy/latest/userguide/troubleshooting-ec2-instances.html)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDY5Nzg2NDAsLTE5MTI4MTgzNTMsLT
E5NjE0OTExMTksMTk1ODYzOTU2OSwtMTQ3Nzc2OTcxNiwxOTcz
MTgxMzM2XX0=
-->